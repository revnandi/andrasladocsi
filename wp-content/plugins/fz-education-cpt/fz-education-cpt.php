...
/**
 * Plugin Name: FZ Education CPT
 * Description: Adds custom Education post type
 * Version: 1.0
...
function education_cpt() {
	...
	$labels = array(
		...
		'add_new_item'          => __( 'Add new Education Item', 'text_domain' ),
		'add_new'               => __( 'Add Education Item', 'text_domain' ),
...
add_action( 'init', 'education_cpt', 0 );