...
/**
 * Plugin Name: FZ Awards CPT
 * Description: Adds custom Awards post type
 * Version: 1.0
...
function awards_cpt() {
	...
	$labels = array(
		...
		'all_items'             => __( 'Összes Award', 'text_domain' ),
		'add_new_item'          => __( 'Add new Award Item', 'text_domain' ),
		'add_new'               => __( 'Add Award Item', 'text_domain' ),
