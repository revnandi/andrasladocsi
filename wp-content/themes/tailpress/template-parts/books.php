    ...
    <?php while ($query->have_posts()): $query->the_post(); ?>
        ...
        <?php the_title(); ?>
          <?php if (has_post_thumbnail()): ?>
            <div
              class="absolute hidden w-32 h-32 overflow-hidden border al_hoverable_link_image al_hoverable_image group-hover:block group md:col-span-5 aspect-wide-header aspect-square border-turquoise">
